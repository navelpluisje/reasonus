export default {
  ...
  extra: [
    {
      title: "Using your own filters",
      description: `
      <p>
        To use your own filters press <b>[Left Shift] + All</b>. This will show all your self created filters in the displays.
        If you have created more then 8/16 filters, use the pan encoder to scroll to the next filters.
      </p>
      <img src="/images/filter-display.svg" />
      <p>
        If there is a filter available press the <b>Select</b>-button to select the filter. The <b>All</b>-button will now be yellow.<br/>
      </p>
      <p>
