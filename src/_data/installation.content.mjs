  ...
  blocks: [
    {
      ...
      content: `
        <p>ReaSonus Native has the following dependencies:</p>
        <ul>
    ...
    },
    {
      ...
      content: `
        <p>Currently the only way of installing ReaSonus FaderPort is by downloading the latest version and manually install it. The plan it to make it available for ReaPack.</p>
        <p>
            <a class="button" href="https://github.com/navelpluisje/Reasonus-Native/releases/latest">Download ReaSonus FaderPort</a>
        </p>
    ...
    },
    {
      ...
      content: `
            <p>
                REAPER does not reinitialize midi devices when they get activated with REAPER already running. You can in that case open the preferences, open the settings page of ReaSonus FaderPort under <i>Control/OSC/Web</i> and close it again. <br/>
