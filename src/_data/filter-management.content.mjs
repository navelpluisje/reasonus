  ...
  blocks: [
    {
      content: `
            ...
            <p>Adding a new filter is as simpel as deleting one. Click the 'plus' button to create a new one.</p>
            <p>By selectin a filter and use the arrow buttons you are able to change the order of the filters. This is also the order the filters are displayed.</p>
            ...
            <ul>
              ...
              <li><b>Filter text:</b> Adding a text can be done bij entering it i the input field and click the 'plus' button. Remoing an item can be done by selecting it and clicking the 'minus' button under the list.</li>
              <li><b>Show track sibblings:</b> Show all the sibbling tracks of the tracks with matching names</li>
              <li><b>Show track parents:</b> Show all the parent tracks of the tracks with matching names</li>
              <li><b>Show track children:</b> Show all the child tracks of the tracks with matching names</li>
