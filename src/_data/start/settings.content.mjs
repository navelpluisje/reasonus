...
<p>First of all you should select the correct <b>Control surface mode</b>. Select <b>ReaSonus FaderPort 8 &amp; 16</b> for the FaderPort 8 or 16 or select <b>ReaSonus FaderPort V2</b> for the FaderPort V2 and the settings as displayed in the image should appear:</p>
<ul>
...
<p>The Documentation button should open your default browser and open this website</p>
    ...
    FP_V2: {
      title: "FaderPort V2",
      content: `
<p>First of all you should select the correct <b>Control surface mode</b>. Select <b>ReaSonus FaderPort V2</b> for the FaderPort 8 or 16 or select <b>ReaSonus FaderPort V2</b> for the FaderPort V2 and the settings as displayed in the image should appear:</p>
<ul>
    <li><b>MIDI In:</b> Select the proper MIDI Input</li>
    <li><b>MIDI Out:</b> Select the proper MIDI Input</li>
</ul>
